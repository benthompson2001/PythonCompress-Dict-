...
if welcome == '1':
    ...
    savename = input("What would you like to save this data as (eg. oliverreadabook)?: ")
    try:
    ...
    global finallist
    finallist =[]
    filetoopen = input("What is the file name that you would like to open (eg. oliverreadabook)?: ")
    try:
